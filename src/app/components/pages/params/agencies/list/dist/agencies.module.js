...
var agencies_component_1 = require("./agencies.component");
...
var ParamsModule = /** @class */ (function () {
    ...
    ParamsModule = __decorate([
        core_1.NgModule({
            declarations: [agencies_component_1.AgenciesComponent],
            imports: [
                common_1.CommonModule,
                agencies_routing_module_1.EcommProductRoutingModule,
