...
@Component({
  selector: 'app-contenance-list',
  templateUrl: './contenance-list.component.html',
  styleUrls: ['./contenance-list.component.scss']
})
export class ContenanceListComponent implements OnInit, OnChanges{
