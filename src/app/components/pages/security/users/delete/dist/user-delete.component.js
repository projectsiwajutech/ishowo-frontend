...
var UserDeleteComponent = /** @class */ (function () {
    function UserDeleteComponent(router, activeModal, userService, route) {
        this.router = router;
    ...
    UserDeleteComponent.prototype.ngOnChanges = function () {
        this.isDeleting = false;
        this.isCompleted = false;
        this.isSuccess = false;
    };
    //create object
    UserDeleteComponent.prototype["delete"] = function () {
        var _this = this;
        this.show = true;
    ...
    //show creation form
    UserDeleteComponent.prototype.showCreationForm = function () {
        this.isDeleting = false;
        this.isCompleted = false;
        this.isSuccess = false;
    };
    //hide the form
    UserDeleteComponent.prototype.hideForm = function () {
        this.isDeleting = false;
        this.isCompleted = false;
        this.isSuccess = false;
        this.item = null;
    ...
    //Suppression réussie
    UserDeleteComponent.prototype.successSwal = function () {
        var _this = this;
    ...
    UserDeleteComponent.prototype.errorSwal = function () {
        var _this = this;
    ...
    __decorate([
        core_1.Input()
    ], UserDeleteComponent.prototype, "item");
    __decorate([
        core_1.Input()
    ], UserDeleteComponent.prototype, "subject");
    __decorate([
        core_1.Output()
    ], UserDeleteComponent.prototype, "deleted");
