...
var SigninComponent = /** @class */ (function () {
    function SigninComponent(profilService, libraryService, locStorService, ngxService, router) {
        var _this = this;
        ...
        this.refreshTic();
        this.freshTic = window.setInterval(function () { return _this.refreshTic(); }, 3600000);
    }
    ...
    SigninComponent.prototype.signin = function () {
        ...
        this.profilService.login(this.item)
            ...
            if (result === null) {
                ...
                _this.locStorService.saveUser(result);
                //redirect
