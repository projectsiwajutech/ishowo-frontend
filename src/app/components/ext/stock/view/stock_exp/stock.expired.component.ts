...
/**
 * Created by Utilisateur on 02/04/2017.
 */
...
@Component({
  selector: 'it-stock-expired',
  templateUrl: './stock.expired.component.html',
  //styleUrls: ['./orders.component.css']

})

export class StockExpiredComponent implements OnInit, OnChanges{
  ...
  getStockView(): void {
    ...
    let periodParam: PeriodParam = new PeriodParam();
    periodParam.startDate = new Date();
    this.productService.getStockExpired(periodParam, this.user)
      .then(
        stock_view => {
