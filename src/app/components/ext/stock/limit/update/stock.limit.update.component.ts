...
@Component({
  selector: 'it-stock-limit-update',
  templateUrl: './stock.limit.update.component.html',
  //styleUrls: ['./agencies.component.css']

})

export class StockLimitUpdateComponent implements OnInit, OnChanges{



  visible: boolean = false;
  @Input() item: StockLimit ;
  ...
  selectAgency(): void{
    ...
    //   if(this.item === null || this.item === undefined) this.item = new StockLimit();
    //
