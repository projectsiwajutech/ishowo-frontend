...
@Component({
  selector: 'it-modal-prodsearch',
  templateUrl: './it.modal.prodsearch.component.html',
  styleUrls: ['./it.modal.prodsearch.component.css']
})

export class ItModalProductSearchComponent implements OnInit {
